    ...
    def _method_name(self, event):
        try:
            ...
            if event.mask == pyinotify.IN_CLOSE_WRITE:
                ...
                creationTS = datetime.datetime.fromtimestamp(os.path.getctime(rawfile),local_timezone) 
...
#    delete_temp_file("/tmp/mydaemon.pid")
    delete_temp_file("/home/sambauser/NAS/Log_Out/error.log")
    delete_temp_file("/home/sambauser/NAS/Log_Out/out.log")
    ...
    event_notifier.loop(daemonize=True, pid_file='/tmp/mydaemon.pid', stdout='/home/sambauser/NAS/Log_Out/out.log', stderr='/home/sambauser/NAS/Log_Out/error.log')
